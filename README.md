...
- A workstation/Raspberry Pi will be setup at the entrance to the classroom. ![Setup at entrance to classroom](https://github.com/ericzundel/imagecapturegui/Camera and button.png)
